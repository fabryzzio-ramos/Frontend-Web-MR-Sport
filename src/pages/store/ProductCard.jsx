    ...
    return (
        <div className="bg-[#020617] border border-white/10 rounded-2xl overflow-hidden hover:border-red-500/40 transition group">
            ...
            <div className="p-4 text-center">
                ...
                <button className="mt-3 w-full border border-red-600 text-red-500 py-2 rounded-lg hover:bg-red-600 hover:text-white transition">Agregar al carrito</button>
            </div>
        </div>
    );
}
